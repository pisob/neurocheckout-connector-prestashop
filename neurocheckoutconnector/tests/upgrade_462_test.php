...
require __DIR__ . '/../upgrade/upgrade-4.6.2.php';
if (!upgrade_module_4_6_2(new stdClass())) throw new RuntimeException('Upgrade failed');
...
echo "4.6.2 upgrade preserves merchant settings.\n";
