...
require __DIR__ . '/../upgrade/upgrade-4.6.3.php';
if (!upgrade_module_4_6_3(new stdClass())) throw new RuntimeException('Upgrade failed');
...
echo "4.6.3 upgrade preserves merchant settings.\n";
